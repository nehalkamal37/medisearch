...
import {
  RiSearchLine, RiCustomerService2Line, RiQuestionLine, RiFileList3Line,
  RiMedicineBottleLine, RiBuildingLine, RiGroupLine, RiDashboardLine, RiHistoryLine
} from 'react-icons/ri';
...
const HelpSupportPage: React.FC = () => {
  ...
  return (
    <Container className="py-5 mid">
      ...
      {/* just the centering rules */}
      <style>{`
        .mid { margin-left: 10px; }              /* match your sidebar width */
